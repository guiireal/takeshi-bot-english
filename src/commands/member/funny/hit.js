...
module.exports = {
  name: "hit",
  description: "Hit a user with a punch.",
  commands: ["hit"],
  usage: `${PREFIX}hit @user`,
  /**
  ...
  handle: async ({
    ...
    if (!targetJid) {
      await sendErrorReply(
        "You must mention a user or reply to a message to hit."
      );
      return;
    }
    ...
    await sendGifFromFile(
      ...
      `@${userNumber} gave a bombastic punch to @${targetNumber}!`,
      [userJid, targetJid]
    );
  },
};
